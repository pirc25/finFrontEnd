...
import "./chunk-KKRO3BHI.js";
import "./chunk-Q5BGO65H.js";
import "./chunk-LD452LIL.js";
import "./chunk-LUFASN6N.js";
import "./chunk-TOHNKNPI.js";
import "./chunk-4EN3RTL3.js";
import "./chunk-5RNNPVE3.js";
import "./chunk-E6VKEMUQ.js";
import {
  HTMLElementType,
  _extends,
  alpha,
...
function createUseGridApiEventHandler(registryContainer2) {
  ...
  return function useGridApiEventHandler2(apiRef, eventName, handler, options) {
    ...
    const handlerRef = React9.useRef(null);
...
var useGridVirtualScroller = () => {
  ...
  const previousSize = React36.useRef(null);
...
function useGridApiInitialization(inputApiRef, props) {
  var _a;
  const publicApiRef = React107.useRef(null);
  const privateApiRef = React107.useRef(null);
...
var useGridRegisterPipeApplier = (apiRef, group, callback) => {
  const cleanup = React111.useRef(null);
...
var useGridPreferencesPanel = (apiRef, props) => {
  ...
  const hideTimeout = React128.useRef(void 0);
  const immediateTimeout = React128.useRef(void 0);
